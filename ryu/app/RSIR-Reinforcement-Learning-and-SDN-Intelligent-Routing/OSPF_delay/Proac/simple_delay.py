...
class simple_Delay(app_manager.RyuApp):
    ...
    def write_dijkstra_paths(self):
        ...
        for src in self.awareness.switches:
            for dst in self.awareness.switches:
                if src != dst:
                    paths[src][dst] = self.dijkstra(self.delay_dict, src, dst, visited=[], distances={},
                                                    predecessors={})

        with open(
                '/home/ubuntu/ryu/ryu/app/RSIR-Reinforcement-Learning-and-SDN-Intelligent-Routing/OSPF_delay/Proac/paths_delay.json',
                'w') as json_file:
        ...
        # print(total_time)
        with open(
                '/home/ubuntu/ryu/ryu/app/RSIR-Reinforcement-Learning-and-SDN-Intelligent-Routing/OSPF_delay/Proac/times.txt',
                'a') as txt_file:
    ...
    def dijkstra(self, graph, src, dest, visited=[], distances={}, predecessors={}):
        ...
        if src == dest:
            ...
            for k in graph:
                if k not in visited:
                    unvisited[k] = distances.get(k, float(
                        'inf'))  # sets the cost of link to the src neighbors with the actual value and inf for the non neighbors
    ...
    def get_paths_dijkstra(self):
        file_dijkstra = '/home/ubuntu/ryu/ryu/app/RSIR-Reinforcement-Learning-and-SDN-Intelligent-Routing/OSPF_delay/Proac/paths_delay.json'
    ...
    def get_paths_base(self):
        file_base = '/home/ubuntu/ryu/ryu/app/RSIR-Reinforcement-Learning-and-SDN-Intelligent-Routing/OSPF_delay/Proac/paths_weight.json'
    ...
    def calc_stretch(self):
        ...
        with open(
                '/home/ubuntu/ryu/ryu/app/RSIR-Reinforcement-Learning-and-SDN-Intelligent-Routing/OSPF_delay/Proac/stretch/' + str(
                        self.count) + '_stretch.csv', 'wb') as csvfile:
