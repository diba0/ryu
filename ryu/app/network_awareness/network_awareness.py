...
class NetworkAwareness(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.switch_port_table = {}  # dpip->port_num (交换机所有端口)
        self.access_ports = {}       # dpid->port_num (交换机没有连接到其他交换机的端口，这些端口可能是连接到主机)
        self.interior_ports = {}     # dpid->port_num (交换机连接到其他交换机的端口)
    ...
    def k_shortest_paths(self, graph, src, dst, weight='hop', k=1):
        """
    ...
    def all_k_shortest_paths(self, graph, weight='hop', k=1):
        """
